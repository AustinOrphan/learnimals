# modularization-components - Task 17

Execute task 17 for the modularization-components specification.

## Task Description
Migrate character generation test in src/features/character-generation/test-character-system.js

## Code Reuse
**Leverage existing code**: existing test-character-system.js test logic
...
```
Use the spec-task-executor agent to implement task 17: "Migrate character generation test in src/features/character-generation/test-character-system.js" for the modularization-components specification.
...
3. Implement ONLY task 17: "Migrate character generation test in src/features/character-generation/test-character-system.js"
...
npx @pimzino/claude-code-spec-workflow@latest get-tasks modularization-components 17 --mode single
...
Task details:
- ID: 17
- Description: Migrate character generation test in src/features/character-generation/test-character-system.js
- Leverage: existing test-character-system.js test logic
- Requirements: 1.1, 4.1
```

**Fallback Execution**: If the agent is not available, you can execute:
```
/spec-execute 17 modularization-components
```
...
2. Execute task 17: "Migrate character generation test in src/features/character-generation/test-character-system.js"
...
1. **Mark task complete**: Use the get-tasks script to mark completion:
   ```bash
   npx @pimzino/claude-code-spec-workflow@latest get-tasks modularization-components 17 --mode complete
   ```
2. **Confirm to user**: State clearly "Task 17 has been marked as complete"
...
```
Use the spec-task-implementation-reviewer agent to review the implementation of task 17 for the modularization-components specification.
...
- Specific task 17 details via get-tasks
- All implementation changes for task 17
...
```
Use the spec-duplication-detector agent to analyze code duplication for task 17 of the modularization-components specification.
...
```
Use the spec-integration-tester agent to test the implementation of task 17 for the modularization-components specification.
