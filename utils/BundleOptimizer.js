...
export class BundleOptimizer {
  ...
  prefetchIdleResources() {
    const idleResources = [
      ...
      '/games/bubble-pop/BubblePopGame.js',
  ...
  setupRouteSplitting() {
    ...
    const routeMap = {
      // eslint-disable-next-line no-undef
      '/games/bubble-pop': () => lazyImport('/games/bubble-pop/BubblePopGame.js'),
      '/games/word-scramble': () =>
        // eslint-disable-next-line no-undef
        lazyImport('/games/word-scramble/WordScrambleGame.js'),
      // eslint-disable-next-line no-undef
      '/profile': () => lazyImport('/user/Profile.js'),
      // eslint-disable-next-line no-undef
      '/settings': () => lazyImport('/user/Settings.js'),
    };
  ...
  setupComponentSplitting() {
    ...
    this.registerLazyComponent('Modal', '/components/ui/Modal.js');
    this.registerLazyComponent('Toast', '/components/ui/Toast.js');
    this.registerLazyComponent('CharacterCustomizer', '/components/ui/CharacterCustomizer.js');
  }
