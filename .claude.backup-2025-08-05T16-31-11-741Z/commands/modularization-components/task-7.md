# modularization-components - Task 7

Execute task 7 for the modularization-components specification.

## Task Description
Migrate Card component in src/components/ui/Card.js

## Code Reuse
**Leverage existing code**: existing Card.js implementation (keep all functionality)
...
```
Use the spec-task-executor agent to implement task 7: "Migrate Card component in src/components/ui/Card.js" for the modularization-components specification.
...
3. Implement ONLY task 7: "Migrate Card component in src/components/ui/Card.js"
...
npx @pimzino/claude-code-spec-workflow@latest get-tasks modularization-components 7 --mode single
...
Task details:
- ID: 7
- Description: Migrate Card component in src/components/ui/Card.js
- Leverage: existing Card.js implementation (keep all functionality)
- Requirements: 1.1, 1.2
```

**Fallback Execution**: If the agent is not available, you can execute:
```
/spec-execute 7 modularization-components
```
...
2. Execute task 7: "Migrate Card component in src/components/ui/Card.js"
...
1. **Mark task complete**: Use the get-tasks script to mark completion:
   ```bash
   npx @pimzino/claude-code-spec-workflow@latest get-tasks modularization-components 7 --mode complete
   ```
2. **Confirm to user**: State clearly "Task 7 has been marked as complete"
...
```
Use the spec-task-implementation-reviewer agent to review the implementation of task 7 for the modularization-components specification.
...
- Specific task 7 details via get-tasks
- All implementation changes for task 7
...
```
Use the spec-duplication-detector agent to analyze code duplication for task 7 of the modularization-components specification.
...
```
Use the spec-integration-tester agent to test the implementation of task 7 for the modularization-components specification.
