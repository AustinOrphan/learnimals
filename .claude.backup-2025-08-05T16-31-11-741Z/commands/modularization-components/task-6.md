# modularization-components - Task 6

Execute task 6 for the modularization-components specification.

## Task Description
Create migration validation tests in tests/unit/migration.test.js

## Code Reuse
**Leverage existing code**: existing test utilities and fixtures
...
```
Use the spec-task-executor agent to implement task 6: "Create migration validation tests in tests/unit/migration.test.js" for the modularization-components specification.
...
3. Implement ONLY task 6: "Create migration validation tests in tests/unit/migration.test.js"
...
npx @pimzino/claude-code-spec-workflow@latest get-tasks modularization-components 6 --mode single
...
Task details:
- ID: 6
- Description: Create migration validation tests in tests/unit/migration.test.js
...
```
/spec-execute 6 modularization-components
```
...
2. Execute task 6: "Create migration validation tests in tests/unit/migration.test.js"
...
1. **Mark task complete**: Use the get-tasks script to mark completion:
   ```bash
   npx @pimzino/claude-code-spec-workflow@latest get-tasks modularization-components 6 --mode complete
   ```
...
```
Use the spec-task-implementation-reviewer agent to review the implementation of task 6 for the modularization-components specification.
...
- Specific task 6 details via get-tasks
- All implementation changes for task 6
...
```
Use the spec-duplication-detector agent to analyze code duplication for task 6 of the modularization-components specification.
...
```
Use the spec-integration-tester agent to test the implementation of task 6 for the modularization-components specification.
