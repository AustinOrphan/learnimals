...
## Usage
```
/Task:6-modularization-components
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create migration validation tests in tests/unit/migration.test.js"

```
Use the @spec-task-executor agent to implement task 6: "Create migration validation tests in tests/unit/migration.test.js" for the modularization-components specification and include all the below context.
...
## Instructions
- Implement ONLY task 6: "Create migration validation tests in tests/unit/migration.test.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modularization-components 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modularization-components 6 --mode complete
```
