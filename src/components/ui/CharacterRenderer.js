...
import { CharacterSchema, DefaultCharacterTemplates } from '../../data/characterSchema.js';
...
class CharacterRenderer extends BaseComponent {
  ...
  createGradients(defs) {
    const { primary, secondary, accent } = this.character.appearance.colors;
   ...
   * @param {NodeList} eyes - Eye elements
   */
  applyThinkingAnimation(body, eyes) {
