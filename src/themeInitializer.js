...
// Updated: 2025-06-18 - Removed ES6 imports for compatibility
...
(function () {
  ...
  if (savedThemeMode) {
    document.documentElement.setAttribute(
      'data-theme',
      savedThemeMode === 'dark' ? 'night' : savedThemeName
    );
  } else {
  ...
  function toggleMode() {
    ...
    if (metaThemeColor) {
      metaThemeColor.setAttribute('content', newMode === 'dark' ? '#222f3e' : '#ffeaa7');
    }
