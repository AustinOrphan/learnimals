...
class SubjectTemplateLoader {
  ...
  /**
     * Render the template directly into the current page (CSP-compliant alternative to document.write)
     * 
     * @param {Object} options - Configuration options for the template
     */
  static async renderTemplate(options) {
    ...
    if (content) {
      ...
      // Replace current document content with parsed content
      document.documentElement.innerHTML = doc.documentElement.innerHTML;
      
      // Re-initialize scripts and components as needed
      const event = new CustomEvent('templateRendered', { detail: options });
