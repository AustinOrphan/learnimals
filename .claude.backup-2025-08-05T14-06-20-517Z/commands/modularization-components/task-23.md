...
```
Use the spec-task-executor agent to implement task 23: "Create migration rollback script in scripts/rollbackMigration.js" for the modularization-components specification.
...
3. Implement ONLY task 23: "Create migration rollback script in scripts/rollbackMigration.js"
...
npx @pimzino/claude-code-spec-workflow@latest get-tasks modularization-components 23 --mode single
...
```
/spec-execute 23 modularization-components
```
...
2. Execute task 23: "Create migration rollback script in scripts/rollbackMigration.js"
...
1. **Mark task complete**: Use the get-tasks script to mark completion:
   ```bash
   npx @pimzino/claude-code-spec-workflow@latest get-tasks modularization-components 23 --mode complete
   ```
...
```
Use the spec-task-implementation-reviewer agent to review the implementation of task 23 for the modularization-components specification.
...
```
Use the spec-duplication-detector agent to analyze code duplication for task 23 of the modularization-components specification.
...
```
Use the spec-integration-tester agent to test the implementation of task 23 for the modularization-components specification.
