# modularization-components - Task 10

Execute task 10 for the modularization-components specification.

## Task Description
Migrate PlaceValueManipulative in src/components/ui/PlaceValueManipulative.js

## Code Reuse
**Leverage existing code**: existing PlaceValueManipulative.js educational logic
...
```
Use the spec-task-executor agent to implement task 10: "Migrate PlaceValueManipulative in src/components/ui/PlaceValueManipulative.js" for the modularization-components specification.
...
3. Implement ONLY task 10: "Migrate PlaceValueManipulative in src/components/ui/PlaceValueManipulative.js"
...
npx @pimzino/claude-code-spec-workflow@latest get-tasks modularization-components 10 --mode single
...
Task details:
- ID: 10
- Description: Migrate PlaceValueManipulative in src/components/ui/PlaceValueManipulative.js
- Leverage: existing PlaceValueManipulative.js educational logic
- Requirements: 1.1, 2.1
```

**Fallback Execution**: If the agent is not available, you can execute:
```
/spec-execute 10 modularization-components
```
...
2. Execute task 10: "Migrate PlaceValueManipulative in src/components/ui/PlaceValueManipulative.js"
...
1. **Mark task complete**: Use the get-tasks script to mark completion:
   ```bash
   npx @pimzino/claude-code-spec-workflow@latest get-tasks modularization-components 10 --mode complete
   ```
2. **Confirm to user**: State clearly "Task 10 has been marked as complete"
...
```
Use the spec-task-implementation-reviewer agent to review the implementation of task 10 for the modularization-components specification.
...
- Specific task 10 details via get-tasks
- All implementation changes for task 10
...
```
Use the spec-duplication-detector agent to analyze code duplication for task 10 of the modularization-components specification.
...
```
Use the spec-integration-tester agent to test the implementation of task 10 for the modularization-components specification.
