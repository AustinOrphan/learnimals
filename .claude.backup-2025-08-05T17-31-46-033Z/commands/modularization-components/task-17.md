...
## Usage
```
/Task:17-modularization-components
```

## Instructions

Execute with @spec-task-executor agent the following task: "Migrate character generation test in src/features/character-generation/test-character-system.js"

```
Use the @spec-task-executor agent to implement task 17: "Migrate character generation test in src/features/character-generation/test-character-system.js" for the modularization-components specification and include all the below context.
...
## Instructions
- Implement ONLY task 17: "Migrate character generation test in src/features/character-generation/test-character-system.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modularization-components 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modularization-components 17 --mode complete
```
