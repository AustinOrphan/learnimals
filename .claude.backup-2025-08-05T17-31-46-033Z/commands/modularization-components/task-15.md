...
## Usage
```
/Task:15-modularization-components
```

## Instructions

Execute with @spec-task-executor agent the following task: "Migrate math subject handler in src/features/subjects/math/math.js"

```
Use the @spec-task-executor agent to implement task 15: "Migrate math subject handler in src/features/subjects/math/math.js" for the modularization-components specification and include all the below context.
...
## Instructions
- Implement ONLY task 15: "Migrate math subject handler in src/features/subjects/math/math.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modularization-components 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modularization-components 15 --mode complete
```
