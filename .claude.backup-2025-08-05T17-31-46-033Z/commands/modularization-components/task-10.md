...
## Usage
```
/Task:10-modularization-components
```

## Instructions

Execute with @spec-task-executor agent the following task: "Migrate PlaceValueManipulative in src/components/ui/PlaceValueManipulative.js"

```
Use the @spec-task-executor agent to implement task 10: "Migrate PlaceValueManipulative in src/components/ui/PlaceValueManipulative.js" for the modularization-components specification and include all the below context.
...
## Instructions
- Implement ONLY task 10: "Migrate PlaceValueManipulative in src/components/ui/PlaceValueManipulative.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modularization-components 10 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modularization-components 10 --mode complete
```
