...
## Usage
```
/Task:22-modularization-components
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create end-to-end educational workflow test in tests/e2e/modularEducationFlow.test.js"

```
Use the @spec-task-executor agent to implement task 22: "Create end-to-end educational workflow test in tests/e2e/modularEducationFlow.test.js" for the modularization-components specification and include all the below context.
...
## Instructions
- Implement ONLY task 22: "Create end-to-end educational workflow test in tests/e2e/modularEducationFlow.test.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modularization-components 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modularization-components 22 --mode complete
```
