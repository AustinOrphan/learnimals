...
describe('Progress Tracking System Integration', () => {
    ...
    it('should track progress across multiple subjects', () => {
      const mockProgressTracker = {
        ...
        recordGameCompletion: vi.fn(function(gameData) {
          ...
          subjectProgress.averageScore = Math.round(subjectProgress.totalScore / subjectProgress.gamesCompleted);
          ...
          this.userProgress.overallLevel = Math.floor(this.userProgress.totalExperience / (expPerLevel * 2)) + 1;
  ...
  describe('Achievement System Integration', () => {
    ...
    it('should track achievement progress incrementally', () => {
      ...
      const perfectionistProgress = mockProgressiveAchievements.getAchievementProgress('perfectionist');
