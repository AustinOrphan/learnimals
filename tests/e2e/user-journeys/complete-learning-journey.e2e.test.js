...
describe('Complete Learning Journey E2E', () => {
  ...
  test(
    'first-time visitor completes full learning journey',
    async () => {
      ...
      await expect
        .element(page.getByRole('heading', { name: /create your character/i }))
        .toBeInTheDocument();
      ...
      await expect
        .element(page.getByRole('heading', { name: /math with max/i }))
        .toBeInTheDocument();
      await expect
        .element(page.getByText(/learn math with your feline friend/i))
        .toBeInTheDocument();
      ...
      await expect
        .element(page.getByRole('heading', { name: /science with bella/i }))
        .toBeInTheDocument();
