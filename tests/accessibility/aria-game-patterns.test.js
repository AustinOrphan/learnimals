...
describe('ARIA Game-Specific Patterns', () => {
  ...
  describe('Canvas Game Accessibility', () => {
    it('should provide accessible canvas with proper labeling', () => {
      ...
      instructions.textContent = 'Use arrow keys to move, space to pop bubbles with correct answers';
  ...
  describe('Quiz and Question Patterns', () => {
    ...
    it('should handle multiple choice with explanations', () => {
      ...
      const choices = [
        ...
        { value: 'whale', text: 'Whale', explanation: 'Correct! Whales are marine mammals', correct: true },
      ...
      overallExplanation.textContent = 'Excellent! Whales are indeed mammals that live in the ocean.';
    ...
    it('should handle drag-and-drop quiz patterns', () => {
      ...
      instructions.textContent = 'Drag each animal to its correct habitat. Use Tab to navigate, Space to pick up, arrow keys to move, Space again to drop.';
      instructions.className = 'sr-only';
  ...
  describe('Progress and Achievement Patterns', () => {
    ...
    it('should validate streak and achievement tracking', () => {
      ...
      badges.forEach(badge => {
        ...
        badgeButton.setAttribute('aria-describedby', `${badge.name.toLowerCase().replace(' ', '-')}-desc`);
      ...
      newBadgeAlert.textContent = 'New badge earned: Science Explorer! You completed 10 experiments!';
  ...
  describe('Timer and Time-based Game Patterns', () => {
    ...
    it('should validate speed game with performance feedback', () => {
      ...
      stats.textContent = 'Problem 1 of 20 complete. Score: 1 correct, 0 incorrect. Time: 57 seconds remaining.';
  ...
  describe('Character Interaction Patterns', () => {
    it('should validate character dialogue system', () => {
      ...
      dialogueText.textContent = 'Excellent choice! Here\'s a helpful strategy: try breaking the problem into smaller parts.';
