...
describe('BaseGame Feedback System', () => {
  ...
  describe('Core Functionality', () => {
    ...
    it('should clean up feedback after duration', async () => {
  ...
  describe('Accessibility Features', () => {
    ...
    it('should announce feedback to screen readers', async () => {
      const ariaRegion = game.feedbackState.ariaLiveRegion;
    ...
    it('should use assertive announcements for errors', async () => {
      const ariaRegion = game.feedbackState.ariaLiveRegion;
  ...
  describe('Memory Management', () => {
    it('should clean up feedback elements after timeout', async () => {
