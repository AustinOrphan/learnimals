      ...
      it('should scan directory structure recursively', async () => {
        ...
        fs.readdir
          ...
          .mockResolvedValueOnce([
            { name: 'component3.js', isFile: () => true, isDirectory: () => false },
          ]);

        fs.stat.mockResolvedValue({ isFile: () => true, isDirectory: () => false });

        fs.readFile.mockResolvedValue('export default class {}');
  ...
  describe('MixedPatternMigrator', () => {
    ...
    describe('Backup System', () => {
      ...
      it('should create backup before migration', async () => {
        ...
        expect(fs.mkdir).toHaveBeenCalledWith(expect.stringContaining('components/ui'), {
          recursive: true,
        });
      ...
      it('should organize backups by directory structure', async () => {
        ...
        expect(fs.mkdir).toHaveBeenCalledWith(expect.stringContaining('components/ui/forms'), {
          recursive: true,
        });
      });
    });
    ...
    describe('Migration Validation', () => {
      ...
      it('should detect remaining problematic patterns', async () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Validation warning'));
      ...
      it('should require ES6 exports in component files', async () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Validation warning'));
        expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('No ES6 export found'));
    ...
    describe('Rollback System', () => {
      ...
      it('should handle missing backup files gracefully', async () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Backup not found'));
    ...
    describe('Migration Reporting', () => {
      it('should generate comprehensive migration summary', async () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Files migrated: 3'));
      ...
      it('should provide next steps guidance', async () => {
        ...
        migrator.results = {
          ...
          skipped: 1,
          errors: [],
          migrations: [{ filePath: 'test.js', appliedRules: [] }],
          backups: [],
        };
