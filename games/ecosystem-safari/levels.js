...
export const levels = [
  ...
  },
  {
    ...
    goal: { type: 'survive', requires: ['grass', 'rabbit', 'hawk'], durationSec: 25 },
    challenge: null,
    lesson: 'biodiversity',
  ...
  },
  {
    ...
    starting: [
      { species: 'oak_tree', population: 28 },
      { species: 'deer', population: 5 },
  ...
  },
  {
    ...
    starting: [
      ...
      { species: 'rabbit', population: 4 },
      { species: 'hawk', population: 3 },
      { species: 'bacteria', population: 4 },
    ],
    palette: ['rabbit', 'hawk', 'bacteria'],
    goal: { type: 'biodiversity', minSpecies: 3, timeoutSec: 18 },
