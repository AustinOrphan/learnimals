...
## Usage
```
/Task:7-modularization-components
```

## Instructions

Execute with @spec-task-executor agent the following task: "Migrate Card component in src/components/ui/Card.js"

```
Use the @spec-task-executor agent to implement task 7: "Migrate Card component in src/components/ui/Card.js" for the modularization-components specification and include all the below context.
...
## Instructions
- Implement ONLY task 7: "Migrate Card component in src/components/ui/Card.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modularization-components 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modularization-components 7 --mode complete
```
