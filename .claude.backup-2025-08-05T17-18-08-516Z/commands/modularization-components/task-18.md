...
## Usage
```
/Task:18-modularization-components
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create component migration report generator in scripts/generateMigrationReport.js"

```
Use the @spec-task-executor agent to implement task 18: "Create component migration report generator in scripts/generateMigrationReport.js" for the modularization-components specification and include all the below context.
...
## Instructions
- Implement ONLY task 18: "Create component migration report generator in scripts/generateMigrationReport.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modularization-components 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modularization-components 18 --mode complete
```
