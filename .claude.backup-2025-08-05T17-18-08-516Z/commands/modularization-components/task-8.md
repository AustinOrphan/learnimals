...
## Usage
```
/Task:8-modularization-components
```

## Instructions

Execute with @spec-task-executor agent the following task: "Migrate FormComponent in src/components/forms/FormComponent.js"

```
Use the @spec-task-executor agent to implement task 8: "Migrate FormComponent in src/components/forms/FormComponent.js" for the modularization-components specification and include all the below context.
...
## Instructions
- Implement ONLY task 8: "Migrate FormComponent in src/components/forms/FormComponent.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modularization-components 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modularization-components 8 --mode complete
```
