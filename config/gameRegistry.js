...
export const gameRegistry = [
  // Word Scramble Game - Already properly extends BaseGame
  {
    ...
    scriptPath: '/games/word-scramble/wordScramble.js',
    styleSheet: '/games/word-scramble/wordScramble.css',
  ...
  // Bubble Pop Game - Now fully migrated to BaseGame
  {
    ...
    // Dependencies
    dependencies: ['/games/bubble-pop/Bubble.js'],
  },
  ...
  // Pizza Maker Game - Now fully extends BaseGame for DOM-based gameplay
  {
    ...
    scriptPath: '/games/pizza-maker/PizzaMakerGame.js',
    styleSheet: '/games/pizza-maker/pizzaMaker.css',
    ...
    // Dependencies
    dependencies: ['/utils/AnimationManager.js'],
  },
  ...
  // Element Match Game - Already fully extends BaseGame for canvas-based gameplay
  {
    ...
    scriptPath: '/games/element-match/elementMatch.js',
    styleSheet: '/games/element-match/elementMatch.css',
  ...
  // Memory Card Game - Pattern matching and memory training
  {
    ...
    scriptPath: '/games/memory-cards/memoryCards.js',
    styleSheet: '/games/memory-cards/memoryCards.css',
  ...
  // Number Bonds Game - Math relationships
  {
    ...
    scriptPath: '/games/number-bonds/numberBonds.js',
    styleSheet: '/games/number-bonds/numberBonds.css',
  ...
  // Pattern Blocks Game - Geometry and spatial reasoning
  {
    ...
    scriptPath: '/games/pattern-blocks/patternBlocks.js',
    styleSheet: '/games/pattern-blocks/patternBlocks.css',
  ...
  // Story Builder Game - Creative writing and reading
  {
    ...
    scriptPath: '/games/story-builder/storyBuilder.js',
    styleSheet: '/games/story-builder/storyBuilder.css',
  ...
  // Number Line Jump Game - Already fully extends BaseGame for canvas-based gameplay
  {
    ...
    scriptPath: '/games/number-line-jump/numberLineJump.js',
    styleSheet: '/games/number-line-jump/numberLineJump.css',
  ...
  // Color Palette Game - Already fully extends BaseGame for canvas-based gameplay
  {
    ...
    scriptPath: '/games/color-palette/colorPalette.js',
    styleSheet: '/games/color-palette/colorPalette.css',
    ...
    // Dependencies
    dependencies: ['/games/color-palette/colorData.js'],
  },
  ...
  // Sentence Builder Game - Already fully extends BaseGame for DOM-based gameplay
  {
    ...
    scriptPath: '/games/sentence-builder/sentenceBuilder.js',
    styleSheet: '/games/sentence-builder/sentenceBuilder.css',
    ...
    // Dependencies
    dependencies: ['/games/sentence-builder/sentenceData.js'],
  },
];
