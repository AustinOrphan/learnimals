...
## Usage
```
/Task:14-modularization-components
```

## Instructions

Execute with @spec-task-executor agent the following task: "Migrate htmlEscape utility in src/utils/htmlEscape.js"

```
Use the @spec-task-executor agent to implement task 14: "Migrate htmlEscape utility in src/utils/htmlEscape.js" for the modularization-components specification and include all the below context.
...
## Instructions
- Implement ONLY task 14: "Migrate htmlEscape utility in src/utils/htmlEscape.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks modularization-components 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks modularization-components 14 --mode complete
```
